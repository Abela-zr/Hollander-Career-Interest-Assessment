...
App({
  ...
  globalData:{
    userInfo: "hello",
    question:[{"question":"强壮而敏捷的身体对我很重要","option":{"A":"对","B":"错"}},{"question":"我必须彻底的了解事情的真相","option":{"A":"对","B":"错"}}
    ,{"question":"我的心情受音乐、色彩和美丽事物的影响很大","option":{"A":"对","B":"错"}},{"question":"和他人的关系丰富了我的生命并使它有意义","option":{"A":"对","B":"错"}}
    ,{"question":"我自信会成功","option":{"A":"对","B":"错"}},{"question":"我做事必须有清楚的指引","option":{"A":"对","B":"错"}}
    ...
    ,{"question":"我喜欢使用双手做事","option":{"A":"对","B":"错"}},{"question":"探索新构思使我满意","option":{"A":"对","B":"错"}}
    ,{"question":"我是寻求新方法来发挥我的创造力","option":{"A":"对","B":"错"}},{"question":"我认为能把自己的焦虑和别人分担是很重要的","option":{"A":"对","B":"错"}}
    ,{"question":"成为群体中的关键任务执行者，对我来说很重要","option":{"A":"对","B":"错"}},{"question":"我对于自己能重视工作中的所有细节感到骄傲","option":{"A":"对","B":"错"}}
    ,{"question":"我不在意工作把手弄脏","option":{"A":"对","B":"错"}},{"question":"我认为教育是个发展及磨练脑力的终身学习过程","option":{"A":"对","B":"错"}}
    ...
    ,{"question":"我喜欢直言不讳，不喜欢转弯抹角","option":{"A":"对","B":"错"}},{"question":"我在解决问题前必须把问题进行彻底分析","option":{"A":"对","B":"错"}}
    ,{"question":"我喜欢重新布置我的环境，使他们与众不同","option":{"A":"对","B":"错"}},{"question":"我经常借着和别人交谈来解决自己的问题","option":{"A":"对","B":"错"}}
    ,{"question":"我常想起草一个计划，而由别人的完成细节","option":{"A":"对","B":"错"}},{"question":"准时对我来说非常重要","option":{"A":"对","B":"错"}}
    ,{"question":"从事户外活动使我神清气爽","option":{"A":"对","B":"错"}},{"question":"我不断的问：为什么","option":{"A":"对","B":"错"}}
    ,{"question":"我喜欢自己的工作能过抒发我的情绪和感觉","option":{"A":"对","B":"错"}},{"question":"我喜欢帮助别人找可以和他人相互关注的方法","option":{"A":"对","B":"错"}}
    ...
    ,{"question":"升迁和进步对我极重要","option":{"A":"对","B":"错"}},{"question":"当我把每日学习计划好时，我会比较有安全感","option":{"A":"对","B":"错"}}
    ,{"question":"我不害怕过重的学习负荷，且知道学习的重点","option":{"A":"对","B":"错"}},{"question":"我喜欢能使我思考，给我新观念的书","option":{"A":"对","B":"错"}}
    ,{"question":"我希望能够看到艺术表演、戏剧及好的电影","option":{"A":"对","B":"错"}},{"question":"我对别人的情绪低潮相当的敏感","option":{"A":"对","B":"错"}}
    ,{"question":"能影响别人使我感到兴奋","option":{"A":"对","B":"错"}},{"question":"当我答应一件事时，我会竭尽监督所有细节","option":{"A":"对","B":"错"}}
    ,{"question":"当我答应一件事时，我会竭尽监督所有细节","option":{"A":"对","B":"错"}}]
  }
})
